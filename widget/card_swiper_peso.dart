...
import 'package:pruebas/src/pages/details_pages/detailPeso.dart';
...
class CardSwiperPeso extends StatelessWidget {
  ...
  CardSwiperPeso({@required this.color1, this.color2, this.lista, this.paginaDetail, this.info});
          ...
          return  InkWell(
            onTap: (){
              Navigator.push(context, PageRouteBuilder(
                ...
                pageBuilder: (context,a,b)=> DetailPagePeso(pesoInfo: peso[index]),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children:[
                        ...
                        SizedBox(width: 94.0),
                        Icon(FontAwesomeIcons.dumbbell, color: Colors.white, size: 50.0),
                    ]),
                  ),
