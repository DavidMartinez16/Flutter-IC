...
class CardSwiperInferior extends StatelessWidget {
  ...
  CardSwiperInferior({@required this.color1, this.color2, this.lista, this.paginaDetail, this.info});
          ...
          return  InkWell(
            onTap: (){
              Navigator.push(context, PageRouteBuilder(
                ...
                pageBuilder: (context,a,b)=> DetailPage(calentamientoInfo: exercises[index]),
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children:[
                        ...
                        SizedBox(width: 94.0),
                        Icon(FontAwesomeIcons.walking, color: Colors.white, size: 50.0),
                    ]),
                  ),
